///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.40.2.214/W32 for ARM        15/May/2021  19:04:33
...
//    Command line =
//        -f C:\Users\KONSTA~1\AppData\Local\Temp\EW49B.tmp
...
//   22 #include "port.hpp"
//   23 #include "spi.hpp"
//   24 #include "TempSens.hpp"
//   25 using namespace std;
//   26 
//   27 constexpr std::uint32_t UartSpeed9600 = std::uint32_t(16000000U / 9600U) ;
//   28 
//   29 extern "C" {
        ...
        THUMB
//   30 int __low_level_init(void)
//   31 {
__low_level_init:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//   32   //Switch on external 16 MHz oscillator
//   33   RCC::CR::HSION::On::Set();
...
//   34   while (!RCC::CR::HSIRDY::Ready::IsSet())
??__low_level_init_0:
...
//   36 
//   37   }
//   38   //Switch system clock on external oscillator
//   39   RCC::CFGR::SW::Hsi::Set() ;
...
//   40   while (!RCC::CFGR::SWS::Hsi::IsSet())
??__low_level_init_1:
...
//   43   }
//   44     
//   45   //Switch on clock on PortA a
//   46   RCC::AHB1ENR::GPIOAEN::Enable::Set();
...
//   47   RCC::AHB1ENR::GPIOBEN::Enable::Set();
...
//   49   RCC::APB1ENR::SPI2EN::Enable::Set();
...
//   51   
//   52 GPIOB::MODERPack<
//   53         GPIOB::MODER::MODER1::Output,         //CS
//   54         GPIOB::MODER::MODER2::Output,         //DC
//   55         GPIOB::MODER::MODER8::Output,
//   56         GPIOB::MODER::MODER9::Output,
//   57         GPIOB::MODER::MODER13::Alternate,			//PortC.3 scl
//   58         GPIOB::MODER::MODER15::Alternate			//PortC.2 sda
//   59     >::Set() ;
...
//   60 
//   61     GPIOB::AFRHPack<
//   62         GPIOB::AFRH::AFRH13::Af5,
//   63         GPIOB::AFRH::AFRH15::Af5
//   64     >::Set() ;
...
//   67     
//   68     GPIOC::MODERPack<
//   69         GPIOC::MODER::MODER5::Output,
//   70         GPIOC::MODER::MODER8::Output,
//   71         GPIOC::MODER::MODER9::Output,
//   72 				GPIOC::MODER::MODER2::Input, //Busy
//   73 				GPIOC::MODER::MODER3::Output //Reset
//   74     >::Set() ;
...
//   76      
//   77       SPI2::CR1Pack<
//   78         SPI2::CR1::MSTR::Master,   //SPI2 master
//   79         SPI2::CR1::BIDIMODE::Unidirectional2Line,
//   80         SPI2::CR1::DFF::Data8bit,
//   81         SPI2::CR1::CPOL::High,
//   82         SPI2::CR1::CPHA::Phase2edge,
//   83         SPI2::CR1::SSM::NssSoftwareEnable,
//   84         SPI2::CR1::SSI::Value1,
//   85         SPI2::CR1::BR::PclockDiv2,
//   86         SPI2::CR1::LSBFIRST::MsbFisrt,
//   87         SPI2::CR1::CRCEN::CrcCalcDisable
//   88     >::Set() ;
...
//   93   
//   94   
//   95   RCC::APB1ENR::I2C1EN::Enable::Set();//ПОдали тактирование на I2C
...
//   96  
//   97   I2C1::CR1::SMBUS::SmBusMode::Set(); //Включение интерфейса SMBus.
...
//   98   I2C1::CR1::SMBTYPE::Device::Set(); //Тип устройства в режиме.
...
//   99   I2C1::CCR::F_S::StandartMode::Set(); 
...
//  110   
//  111   GPIOB::AFRH::AFRH8::Af4::Set();  //scl
...
//  112   GPIOB::AFRH::AFRH9::Af4::Set();  //sda
...
//  113   
//  114   GPIOB::OTYPER::OT8::OutputOpenDrain::Set();
...
//  115   GPIOB::OTYPER::OT9::OutputOpenDrain::Set();
...
//  116   
//  117   GPIOB::OSPEEDR::OSPEEDR8::HighSpeed::Set() ;
...
//  118   GPIOB::OSPEEDR::OSPEEDR9::HighSpeed::Set() ;
...
//  119   
//  120   GPIOB::PUPDR::PUPDR8::PullUp::Set() ;
...
//  121   GPIOB::PUPDR::PUPDR9::PullUp::Set() ;
...
//  124 
//  125 //SPI
//  126   // PortB.13 - SPI3_CLK, PortB.15 - SPI2_MOSI, PB1 -CS, PB2- DC, PB8 -Reset
//  127 
//  128 
//  129 //USART  
//  130   RCC::APB1ENRPack<
//  131     RCC::APB1ENR::TIM2EN::Enable, 
//  132     RCC::APB1ENR::USART2EN::Enable
//  133     >::Set() ;
...
//  134   
//  135   GPIOA::MODERPack<
//  136     GPIOA::MODER::MODER2::Alternate, // Uart2 TX
//  137     GPIOA::MODER::MODER3::Alternate  // Uart2 RX
//  138     >::Set() ;
...
//  139   
//  140   GPIOA::AFRLPack <
//  141     GPIOA::AFRL::AFRL2::Af7, // Uart2 TX
//  142     GPIOA::AFRL::AFRL3::Af7  // Uart2 RX
//  143     >::Set() ;
...
//  144   
//  145     USART2::BRR::Write(UartSpeed9600);
        MOVW     R0,#+1666
...
//  151 };
//  152 
//  153 using ResetPin = Pin<Port<GPIOC>, 3U, PinWriteable> ;
//  154 using DcPin = Pin<Port<GPIOB>, 2U, PinWriteable> ;
//  155 using CsPin = Pin<Port<GPIOB>, 1U, PinWriteable> ;
//  156 using BusyPin = Pin<Port<GPIOC>, 2U, PinReadable> ;
//  157 
//  158 
//  159 using LcdDriverSpi = Spi<SPI2> ;
//  160 using LcdDriver = ElinkDriver<LcdDriverSpi, ResetPin, DcPin, CsPin, BusyPin, Attributes<BlackAndWhite>> ;
//  161 

        SECTION `.bss`:DATA:REORDER:NOROOT(0)
        DATA
//  162 Button<GPIOC, 13> button;
button:
        DS8 1

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  163 Event event(1000ms, 1);
event:
        DS8 36
...
?_3:
        DATA64
        DC64 1'000
//  164 //UserButton button;
//  165 

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  166 ButtonPoll<Timer> buttonPoll(button,event);
buttonPoll:
        DS8 8
//  167 
//  168 
...
//  171 
        ...
        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  172 Filter filter(10.0F,100.0F);
filter:
        DS8 8

        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  173 TempSens tempSens(filter);
tempSens:
        DS8 8
...
main:
        PUSH     {R4,LR}
          ...
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  176   const char* message = "Hello World \n";
        LDR.N    R4,??DataTable1_17
//  177 
//  178 //  LcdDriver::Init();
//  179 //  LcdDriver::Clear();
//  180 //  
//  181 //  Point point{130U, 10U};
//  182 //  Display<400,300>::DrawString(point, "GodFather") ;
//  183 //  LcdDriver::UpdatePartialWindow(Display<400, 300>::image.data(), 0, 0, 400, 300) ;
//  184 //  point.y = 130 ;
//  185 //  point.x = 100 ;
//  186 
//  187   
//  188   //buttonPoll.ButtonPollInitialization();
//  189   for(;;)
//  190   {
//  191     float value = tempSens.TakeMeas();
??main_0:
        LDR.N    R0,??DataTable1_16
          CFI FunCall _ZN8TempSens8TakeMeasEv
        BL       _ZN8TempSens8TakeMeasEv
//  192   std::cout << value << std::endl;
        ...
        BL       _ZNSolsEPFRSoS_E
//  193   //temp.SetNextUnits();
//  194   
//  195    usartDriver.SendMessage(message, strlen(message));
        MOVS     R0,R4
          CFI FunCall strlen
        BL       strlen
        MOVS     R2,R0
...
_ZN8RegisterILj1073873920ELj32E13ReadWriteModeN5GPIOB14GPIOBMODERBaseEJ10FieldValueI26GPIOB_MODER_MODER15_ValuesINS1_5MODERELj2ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj4ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj16ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj18ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj26ELj2ES0_S2_ES2_Lj2EvES3_IS4_IS5_Lj30ELj2ES0_S2_ES2_Lj2EvEEE3SetIS0_vEEvv:
        LDR.N    R2,??Set_34      ;; 0x40020400
        LDR      R1,[R2, #+0]
        LDR.N    R0,??Set_34+0x4  ;; 0x33f0ffc3
        ANDS     R1,R0,R1
        LDR.N    R0,??Set_34+0x8  ;; 0x88050014
        ORRS     R1,R0,R1
        STR      R1,[R2, #+0]
        BX       LR               ;; return
        DATA
...
_ZN8RegisterILj1073873956ELj32E13ReadWriteModeN5GPIOB13GPIOBAFRHBaseEJ10FieldValueI23GPIOB_AFRL_AFRL7_ValuesINS1_4AFRHELj20ELj4ES0_S2_ES2_Lj5EvES3_IS4_IS5_Lj28ELj4ES0_S2_ES2_Lj5EvEEE3SetIS0_vEEvv:
        LDR.N    R2,??Set_35      ;; 0x40020424
        LDR      R1,[R2, #+0]
        LDR.N    R0,??Set_35+0x4  ;; 0xf0fffff
        ANDS     R1,R0,R1
        LDR.N    R0,??Set_35+0x8  ;; 0x50500000
        ORRS     R1,R0,R1
        STR      R1,[R2, #+0]
        BX       LR               ;; return
        DATA
...
_ZN8RegisterILj1073874944ELj32E13ReadWriteModeN5GPIOC14GPIOCMODERBaseEJ10FieldValueI26GPIOC_MODER_MODER15_ValuesINS1_5MODERELj10ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj16ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj18ELj2ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj4ELj2ES0_S2_ES2_Lj0EvES3_IS4_IS5_Lj6ELj2ES0_S2_ES2_Lj1EvEEE3SetIS0_vEEvv:
        LDR.N    R2,??Set_36      ;; 0x40020800
        LDR      R1,[R2, #+0]
        LDR.N    R0,??Set_36+0x4  ;; 0xfff0f30f
        ANDS     R1,R0,R1
        LDR.N    R0,??Set_36+0x8  ;; 0x50440
        ORRS     R1,R0,R1
        STR      R1,[R2, #+0]
        BX       LR               ;; return
        DATA
...
_ZN8RegisterILj1073756160ELj32E13ReadWriteModeN4SPI211SPI2CR1BaseEJ10FieldValueI20SPI2_CR1_MSTR_ValuesINS1_3CR1ELj2ELj1ES0_S2_ES2_Lj1EvES3_I24SPI2_CR1_BIDIMODE_ValuesIS5_Lj15ELj1ES0_S2_ES2_Lj0EvES3_I19SPI2_CR1_DFF_ValuesIS5_Lj11ELj1ES0_S2_ES2_Lj0EvES3_I20SPI2_CR1_CPOL_ValuesIS5_Lj1ELj1ES0_S2_ES2_Lj1EvES3_I20SPI2_CR1_CPHA_ValuesIS5_Lj0ELj1ES0_S2_ES2_Lj1EvES3_I19SPI2_CR1_SSM_ValuesIS5_Lj9ELj1ES0_S2_ES2_Lj1EvES3_I19SPI2_CR1_SSI_ValuesIS5_Lj8ELj1ES0_S2_ES2_Lj1EvES3_I18SPI2_CR1_BR_ValuesIS5_Lj3ELj3ES0_S2_ES2_Lj0EvES3_I24SPI2_CR1_LSBFIRST_ValuesIS5_Lj7ELj1ES0_S2_ES2_Lj0EvES3_I21SPI2_CR1_CRCEN_ValuesIS5_Lj13ELj1ES0_S2_ES2_Lj0EvEEE3SetIS0_vEEvv:
        LDR.N    R2,??Set_37      ;; 0x40003800
        LDR      R1,[R2, #+0]
        LDR.N    R0,??Set_37+0x4  ;; 0xffff5440
        ANDS     R1,R0,R1
        MOVW     R0,#+775
        ORRS     R1,R0,R1
        STR      R1,[R2, #+0]
...
_ZN8RegisterILj1073887296ELj32E13ReadWriteModeN3RCC14RCCAPB1ENRBaseEJ10FieldValueI25RCC_AHB1ENR_DMA2EN_ValuesINS1_7APB1ENRELj0ELj1ES0_S2_ES2_Lj1EvES3_IS4_IS5_Lj17ELj1ES0_S2_ES2_Lj1EvEEE3SetIS0_vEEvv:
        LDR.N    R2,??Set_38      ;; 0x40023840
        LDR      R1,[R2, #+0]
        LDR.N    R0,??Set_38+0x4  ;; 0xfffdfffe
        ANDS     R1,R0,R1
        ORR      R1,R1,#0x20000
        ORRS     R1,R1,#0x1
        STR      R1,[R2, #+0]
...
// 1'363 bytes in section .rodata
// 9'714 bytes in section .text
// 
// 488 bytes of CODE  memory (+ 9'230 bytes shared)
//  27 bytes of CONST memory (+ 1'336 bytes shared)
//  82 bytes of DATA  memory (+   323 bytes shared)
//
//Errors: none
//Warnings: 2
